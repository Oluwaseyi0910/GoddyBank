...
namespace GoodyBank.Server.Model
{
    public class GoodyBankDbContext : DbContext
    {
        public GoodyBankDbContext(DbContextOptions<GoodyBankDbContext> options): base(options)
        {
